...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg  max-w-sm w-96 mb-20">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full p-2 bg-blue-500 dark:bg-blue-700 text-white rounded flex items-center justify-center"
            disabled={isLoading}
          >
